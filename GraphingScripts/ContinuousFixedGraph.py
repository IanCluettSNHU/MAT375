...
def exp_continuous(t): return P0 * math.exp(r * t)
...
plt.plot(years_axis, continuous_pop_2022, linewidth=1, linestyle='--', color='blue', marker='o', markersize=4,
         label='Continuous  Fixed Percentage Estimation (+1.078%)')
...
# plot labels, etc.
plt.title('Comparison of Continuous Fixed Percentage Model to Actual U.S. Population Data', fontsize=16)
...
plt.savefig("../FixedPercentage/continuous_fixed_comparison.jpg", dpi=300)
#plt.show()
